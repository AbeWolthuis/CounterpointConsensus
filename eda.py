...
def find_jrp_files(root_dir, valid_files=None, invalid_files=None):
    """
...
def load_jrp_data(root_dir, valid_files=None, invalid_files=None, ano_mode='skip'):
    """
    ...
    """
    files = find_jrp_files(root_dir, valid_files, invalid_files)
    records = []
    for f in files:
...
'Oke3025', 'Ort2005', 'Rue1007a', 'Rue1007b', 'Rue1007c', 'Rue1007d', 'Rue1007e', 'Rue1029a', 'Rue1029b', 'Rue1029c', 'Rue1029d', 'Rue1029e', 'Rue1035a', 'Rue1035b', 'Rue1035c', 'Rue1035d', 'Rue1035e', 'Rue2028', 'Rue2030', 'Rue2032', 'Rue3004', 'Rue3013', 'Tin3002']
    ...
    # Example usage:
    df = load_jrp_data(DATASET_PATH, valid_files=valid_files, invalid_files=invalid_files, ano_mode='skip')
